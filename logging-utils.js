  ...
  return {
    ...
    setup(build) {
      ...
      build.onEnd(({ errors }) => {
        ...
        console.clear();
        spinner.succeed(
          chalk.green`Compiled successfully in ${chalk.cyan(buildTime)}`,
        );
        console.log();
        console.log(
        ...
        console.log(
          `  ${chalk.bold(`On your network`)}: ${chalk.cyan(networkUrl)}`,
        );
        console.log();
      });
    },
  ...
  return {
    ...
    setup(build) {
      ...
      build.onEnd(({ errors }) => {
        ...
        console.log(
          `The folder ${chalk.bold(`${outDir}`)} is ready to be deployed`,
        );
        console.log();
